...
def create_ini_file(
    ...
    out = [
        ...
        "OutputIter		    =	10000000000000000000000 \n",
        "OutputTime		=	0. \n",
        "OutputType		=	TSPVvQ \n",
    ]

    modules = [
        "MCInit          	=	Box/Init, InitSphHarmonics ",
        "MCBody		    =	Boussinesq \n",
        "MCPreTS         	=	 \n",
        "MCPostOuter     	=    \n",
        "MCPrePressure   	=    \n",
    ...
    evolution = [
        "RadioactiveDecay/nDecay     =   1                   \n",
        "RadioactiveDecay/Lambda0   =   38.4  \n",
        "RadioactiveDecay/Coeff0	=	1.0   \n",
        "Core/rhoCpVar              =   0.7058823529411765  \n",
    ]
    ...
    numerics = [
        ...
        #"@ini/lineout.ini  \n",
        #"LineOut/OutputEveryN = 100000000000  \n",
        #"LineOut/NoProfiles = yes \n",
    ]
