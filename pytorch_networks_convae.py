...
def get_mass(u, v, bc=False):
    ...
    """
    u = u.view(-1, 1, u.shape[-2], u.shape[-1])
...
def pad_grad(x, p=(1, 1, 1, 1)):
    """
    Pads the gradients of a tensor in all four spatial directions (left, right, top, bottom) using constant gradient padding.
...
class BoundaryLearnedConvolution2D(nn.Module):
    """
    Based on https://geometry.cs.ucl.ac.uk/projects/2019/investigating-edge/
