Physics-Based Surrogate Model for Mantle Convection\
...
After installing PyTorch, open and run load_fluidnet.ipynb to load a pretrained neural network and perform velocity predictions.
